    ...
    <footer class="footer has-cards">
        ...
        <div class="container">
            <div class="row row-grid align-items-center my-md">
                <div class="col-lg-6">
                    <h3 class="text-primary font-weight-light mb-2">Need Help?</h3>
                    <h4 class="mb-0 font-weight-light">Reach out to an AV team member.</h4>
                </div>
            ...
            <div class="row align-items-center justify-content-md-between">
                <div class="col-md-6">
                    <div class="copyright">
                        &copy; {{year}}
                        <a href="https://calvarysouthoc.com" target="_blank" rel="noopener">CSOC AV Team</a>
                    </div>
                </div>
                <!-- <div class="col-md-6">
